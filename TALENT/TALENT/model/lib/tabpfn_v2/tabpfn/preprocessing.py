...
from typing import TYPE_CHECKING, Literal, TypeVar, Union, Optional
...
class EnsembleConfig:
    ...
    polynomial_features: Union[Literal["no", "all"], int]
    feature_shift_count: int
    feature_shift_decoder: Optional[Literal["shuffle", "rotate"]]
    subsample_ix: Optional[npt.NDArray[np.int64]]  # OPTIM: Could use uintp
    ...
    def generate_for_classification(
        ...
        *,
        n: int,
        subsample_size: Optional[Union[int, float]],
        max_index: int,
        add_fingerprint_feature: bool,
        polynomial_features: Union[Literal["no", "all"], int],
        feature_shift_decoder: Optional[Literal["shuffle", "rotate"]],
        preprocessor_configs: Sequence[PreprocessorConfig],
        class_shift_method: Optional[Literal["rotate", "shuffle"]],
        n_classes: int,
        random_state: Union[int, np.random.Generator, None],
        ...
        subsamples: Union[list[None], list[np.ndarray]]
    ...
    def generate_for_regression(
        ...
        *,
        ...
        feature_shift_decoder: Optional[Literal["shuffle", "rotate"]],
        preprocessor_configs: Sequence[PreprocessorConfig],
        target_transforms: Sequence[Union[TransformerMixin, Pipeline, None]],
        random_state: Union[int, np.random.Generator, None],
...
class ClassifierEnsembleConfig(EnsembleConfig):
    ...
    class_permutation: Optional[np.ndarray]
...
class RegressorEnsembleConfig(EnsembleConfig):
    ...
    target_transform: Union[TransformerMixin, Pipeline, None]
