...
class PerFeatureTransformer(nn.Module):
    ...
    def __init__(  # noqa: C901, D417, PLR0913
        ...
        *,
        ...
        nlayers: int = 10,
        y_encoder: Optional[nn.Module] = None,
        decoder_dict: Optional[dict[str, tuple[Optional[type[nn.Module]], int]]] = None,
        ...
        feature_positional_embedding: Optional[Literal[
            "normal_rand_vec",
            "uni_rand_vec",
            "learned",
            "subspace",
        ...
        precomputed_kv: Optional[list[Union[torch.Tensor, tuple[torch.Tensor, torch.Tensor]]]] = None,
        ...
        **layer_kwargs: Any,
        ...
        self.cached_feature_positional_embeddings: Optional[torch.Tensor] = None
    ...
    def reset_save_peak_mem_factor(self, factor: Optional[int] = None) -> None:
    ...
    def _forward(  # noqa: PLR0912, C901
        ...
        *,
        ...
        categorical_inds_to_use: Optional[list[list[int]]] = None
    ...
    def add_embeddings(  # noqa: C901, PLR0912
        ...
        y: torch.Tensor,
        *,
        data_dags: Optional[Iterable[nx.DiGraph]],
        num_features: int,
        seq_len: int,
