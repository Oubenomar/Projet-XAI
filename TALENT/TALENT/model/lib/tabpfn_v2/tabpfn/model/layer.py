...
class PerFeatureEncoderLayer(Module):
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        precomputed_kv: Union[None, torch.Tensor, tuple[torch.Tensor, torch.Tensor]] = None,
    ) -> None:
        super().__init__()
        ...
        self.self_attn_between_features: Optional[MultiHeadAttention] = None
        ...
        self.second_mlp: Optional[MLP] = None
        if second_mlp:
            self.second_mlp = MLP(
                size=d_model,
                hidden_size=dim_feedforward,
