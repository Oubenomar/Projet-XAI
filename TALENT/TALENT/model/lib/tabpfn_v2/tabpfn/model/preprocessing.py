...
class KDITransformerWithNaN(KDITransformer):
    ...
    def fit(self, X: Union[torch.Tensor, np.ndarray], y: Any = None) -> Self:
    ...
    def transform(self, X: Union[torch.Tensor, np.ndarray]) -> np.ndarray:
...
class SafePowerTransformer(PowerTransformer):
    ...
    def fit(self, X: np.ndarray, y: Optional[Any] = None) -> Self:
        super().fit(X, y)
...
def make_box_cox_safe(input_transformer: Union[TransformerMixin, Pipeline]) -> Pipeline:
    """Make box cox save.
...
class RemoveConstantFeaturesStep(FeaturePreprocessingTransformerStep):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.sel_: Optional[list[bool]] = None
...
class ShuffleFeaturesStep(FeaturePreprocessingTransformerStep):
    ...
    def __init__(
        self,
        shuffle_method: Optional[Literal["shuffle", "rotate"]] = "rotate",
        shuffle_index: int = 0,
        ...
        self.index_permutation_: Optional[list[int]] = None
...
class ReshapeFeatureDistributionsStep(FeaturePreprocessingTransformerStep):
    ...
    def get_all_preprocessors(
        num_examples: int,
        random_state: Optional[int] = None,
    ) -> dict[str, Union[TransformerMixin, Pipeline]]:
        all_preprocessors = {
    ...
    def get_all_global_transformers(
        ...
        num_features: int,
        random_state: Optional[int] = None,
    ) -> dict[str, Union[FeatureUnion, Pipeline]]:
        return {
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer_: Optional[Union[Pipeline, ColumnTransformer]] = None
    ...
    def _set_transformer_and_cat_ix(  # noqa: PLR0912
        ...
        n_features: int,
        categorical_features: list[int],
    ) -> tuple[Union[Pipeline, ColumnTransformer], list[int]]:
...
class EncodeCategoricalFeaturesStep(FeaturePreprocessingTransformerStep):
    ...
    def _get_transformer(
        ...
        X: np.ndarray,
        categorical_features: list[int],
    ) -> tuple[Optional[ColumnTransformer], list[int]]:
...
class NanHandlingPolynomialFeaturesStep(FeaturePreprocessingTransformerStep):
    def __init__(
        ...
        *,
        ...
        self.poly_factor_1_idx: Optional[np.ndarray] = None
        self.poly_factor_2_idx: Optional[np.ndarray] = None
