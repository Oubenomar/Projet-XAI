...
class BarDistribution(nn.Module):
    ...
    def forward(
        ...
        logits: torch.Tensor,
        y: torch.Tensor,
        mean_prediction_logits: Optional[torch.Tensor] = None,
    ) -> torch.Tensor:
    ...
    def plot(
        ...
        zoom_to_quantile: Optional[float] = None,
        **kwargs: Any,
    ) -> plt.Axes:
...
class FullSupportBarDistribution(BarDistribution):
    ...
    def pi(
        self,
        logits: torch.Tensor,
        best_f: Union[torch.Tensor, float],
        *,
        maximize: bool = True,
    ) -> torch.Tensor:
        """Acquisition Function: Probability of Improvement.
...
def get_bucket_limits(
    ...
    *,
    ...
    widen_bucket_limits_factor: Optional[float] = None,
) -> torch.Tensor:
