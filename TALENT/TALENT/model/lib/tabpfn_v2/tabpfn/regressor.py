...
class TabPFNRegressor(RegressorMixin, BaseEstimator):
    ...
    forced_inference_dtype_: Optional[_dtype]
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        model_path: Union[str, Path, Literal["auto"]] = "auto",
        device: Union[str, torch.device, Literal["auto"]] = "auto",
        ignore_pretraining_limits: bool = False,
        inference_precision: Union[_dtype, Literal["autocast", "auto"]] = "auto",
        fit_mode: Literal[
            "low_memory",
            "fit_preprocessors",
            "fit_with_cache",
        ...
        random_state: Union[int, np.random.RandomState, np.random.Generator, None] = 0,
        n_jobs: int = -1,
        inference_config: Union[dict, ModelInterfaceConfig, None] = None,
    ) -> None:
        ...
        self.inference_precision: Union[torch.dtype, Literal["autocast", "auto"]] = (
            inference_precision
        )
        self.fit_mode: Literal["low_memory", "fit_preprocessors", "fit_with_cache"] = (
            fit_mode
        )
        self.memory_saving_mode: Union[bool, Literal["auto"], float, int] = (
            memory_saving_mode
        )
    ...
    def fit(self, X: XType, y: YType) -> Self:
        ...
        target_preprocessors: list[Optional[Union[TransformerMixin, Pipeline]]] = []
        for (
    ...
    def predict(
        ...
        *,
        ...
        quantiles: Optional[list[float]] = None,
    ) -> dict[str, Union[np.ndarray, FullSupportBarDistribution]]: ...
    ...
    def predict(  # noqa: C901, PLR0912
        ...
        *,
        ...
        for output, config in self.executor_.iter_outputs(
            ...
            logit_cancel_mask: Optional[np.ndarray]
