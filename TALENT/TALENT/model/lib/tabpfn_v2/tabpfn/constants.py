...
class ModelInterfaceConfig:
    ...
    OUTLIER_REMOVAL_STD: Union[float, None, Literal["auto"]] = "auto"
    ...
    FEATURE_SHIFT_METHOD: Optional[Literal["shuffle", "rotate"]] = "shuffle"
    ...
    """
    CLASS_SHIFT_METHOD: Optional[Literal["rotate", "shuffle"]] = "shuffle"
    ...
    POLYNOMIAL_FEATURES: Union[Literal["no", "all"], int] = "no"
    ...
    """
    SUBSAMPLE_SAMPLES: (
        Union[int, float, None]  # (0,1) percentage, (1+) n samples
    ) = None
    ...
    PREPROCESS_TRANSFORMS: Optional[list[PreprocessorConfig]] = None
