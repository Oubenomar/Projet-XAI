...
class Trompt(nn.Module): #Trompt
    ...
    def forward_for_training(self, x_num : Optional[Tensor] = None,  x_cat : Optional[Tensor] = None):
    ...
    def forward(self, x_num : Optional[Tensor] = None,  x_cat : Optional[Tensor] = None):
